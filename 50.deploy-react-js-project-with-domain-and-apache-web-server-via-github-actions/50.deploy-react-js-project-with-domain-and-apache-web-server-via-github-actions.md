# Deploy React JS Project with Apache Web Server via GitHub Actions

- [Deploy React JS Project with Apache Web Server via GitHub](https://github.com/satyam-seth-learnings/devops-learning/tree/main/49.deploy-react-js-project-with-domain-and-apache-web-server-via-github)
...
- [YouTube Video Link](https://youtu.be/UlV_gzTmsak?si=Q70Z04fPOdrbaUtH)